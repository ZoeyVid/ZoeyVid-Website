function loadView() {
    ...
    .then((json) => {
        ...
        json.links.forEach(element => {
          document.getElementById("links").innerHTML += '<a href="' + element.url + '"><div class="text-center text-white text-2xl font-bold p-6 rounded-md hover:bg-gray-700">' + element.name + '</div></a>';
          console.log(element)
        });
        console.log(json)
    })
